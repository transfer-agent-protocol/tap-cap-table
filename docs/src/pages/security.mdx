...
### Unit Tests
Comprehensive Foundry unit tests (45 tests across 16 contracts) covering:
- Core flows: issuance, transfer, cancellation, repurchase, reissuance, retraction, acceptance
- Edge cases: invalid quantities, insufficient authorized shares, duplicates, access control
- Factory: creation, upgrades, role checks
