...
The Open Cap Table Format ([OCF](https://www.opencaptablecoalition.com/)) is a JSON-based open-source standard for storing and sharing cap table data. TAP vendors the schemas as a git submodule (`ocf/`, [poet-network/tap-ocf](https://github.com/poet-network/tap-ocf.git)). We use OCF to store data offchain.
