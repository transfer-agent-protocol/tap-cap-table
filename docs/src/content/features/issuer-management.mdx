...
| --- | --- | --- |
| Add a TAP record for a cap table that was already deployed | [Register Issuer](/features/issuer-management/create-issuer) | TAP issuer record linked to the existing onchain cap table. |
