...
Valuations are important for tax purposes and fair market value of common stock. These set the price of tokenized shares. They are created and tracked onchain and off with the specific `issuerId`, and are recorded as 409A valuations.
