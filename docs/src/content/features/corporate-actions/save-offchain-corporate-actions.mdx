...
| `CSAR` | Cash-settled stock appreciation rights. Requires `base_price` instead of `exercise_price`. |
| `SSAR` | Stock-settled stock appreciation rights. Requires `base_price` instead of `exercise_price`. |
| `OPTION` | Option that is not NSO or ISO. Requires `exercise_price`. |
