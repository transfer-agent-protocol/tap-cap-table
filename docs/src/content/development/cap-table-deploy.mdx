...
| `tax_ids[]`, `email`, `address`, `comments` | OCF-shaped fields validated against the [TAP OCF pin](https://github.com/transfer-agent-protocol/tap-ocf). |
...
All fields are validated against the [TAP OCF pin](https://github.com/transfer-agent-protocol/tap-ocf).
