...
| Shared demo `CapTableFactory` | `0xcd6Df14406b0569ceEABa884A18717774EdeaCA1` | Permissionless issuer cap-table creation. Read the live implementation from the factory onchain; do not hardcode it. |
